---
title: Introduction
description: "컨테이너, Kubernetes, REST API 등 클라우드 네이티브 애플리케이션 개발 가이드"
date: 2021-09-01
categories: 
- Cloud Native App.
---
...
본 문서에서는 플랫폼(springboot, nodejs, python)을 이용한 Restful API 개발과 Kubernetes에서 실행하기 위한 방법 등을 포함하고 있음.
...
<CardGrid>
  <LinkCard title="Container" href="/blogs/004_cna/container/" description="컨테이너 기술 개요 및 Docker 활용" />
  <LinkCard title="Kubernetes" href="/blogs/004_cna/k8s/" description="Kubernetes 핵심 개념 및 운영" />
  <LinkCard title="REST API" href="/blogs/004_cna/restapi/" description="RESTful API 설계 가이드" />
  <LinkCard title="Tips" href="/blogs/004_cna/tip/" description="클라우드 네이티브 개발 팁" />
</CardGrid>
